...
export default function Hypercerts() {
  ...
  if (!isSDKLoaded) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50">
        <div className="text-blue-600 text-xl font-medium">Loading Farcaster SDK...</div>
      </div>
    );
  }
  ...
  return (
    <div style={{ 
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 py-8 px-4 sm:px-6 mx-auto">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            <img src='./base-logo-in-blue.jpg' className="w-14 mx-auto block mb-4" />
            ...
            <p className="mx-auto text-sm text-gray-600 mb-4">
              Discover and invest in impact projects on Base
            </p>
          ...
          <div className="mb-6">
            <form onSubmit={handleSearch} className="flex gap-2">
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-600 text-white font-medium rounded-lg shadow-sm hover:from-blue-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
              >
                Search
              </button>
              {isSearching && (
          ...
          {loading ? (
            <div className="flex items-center justify-center py-12 bg-white rounded-xl shadow-md border border-blue-100">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 border-4 border-blue-500 border-t-transparent rounded-full animate-spin mb-4"></div>
                <div className="text-blue-600 text-xl font-medium">Loading hypercerts...</div>
              </div>
            </div>
          ) : (
            <div className="space-y-4">
              {hypercerts.map((cert) => (
                <Link href={`/hypercert-details?id=${cert.id}`} key={cert.id} className="group block">
                  <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg border border-blue-100 p-4">
                    <div className="flex">
                      <div className="w-1/3 h-32 overflow-hidden relative">
                        ...
                        {/* <div className="absolute top-2 left-2 bg-white/90 backdrop-blur-sm px-2 py-0.5 rounded-full shadow-sm">
                          <span className="text-blue-700 font-medium text-xs">Hypercert</span>
                        </div> */}
                      </div>
                      <div className="w-2/3 p-2">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <button className="px-3 py-1 bg-gradient-to-r from-blue-500 to-cyan-600 text-white text-xs font-medium rounded-lg shadow-sm hover:from-blue-600 hover:to-cyan-700 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors duration-200">
                            View
                          </button>
                        </div>
                      </div>
